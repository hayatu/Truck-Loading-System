...
<?php
	...
	$conn = db_connect();	
	 ...
	 $query1 = sprintf("select sup.paycheck_id, sup.emp_id, sup.gross_pay_total, sup.commission, sup.fuel,sup.insurance_fee,sup.other_charges, sup.net_pay, sup.sdate, sup.truck_id, sup.edate,sup.week_name,
					...
					<tr>
                       ...
                       <td><i class="fas fa-dollar-sign fa-sm text-black-50"></i><?php echo $rs_paycheck[$i]["other_charges"]; ?></td>						
						...
						<!-- Delete trigger modal-->
							...
							<a href="#" data-href="paycheck_info_delete.php?paycheck-id=<?php echo $rs_paycheck[$i]["paycheck_id"]; ?>" data-toggle="modal" data-target="#confirm-delete" class="btn btn-sm" role="button"><i class="fas fa-trash-alt"></i></a>  
