		...
		<ul class="nav navbar-nav nav-flex-icons ml-auto">			
			...
			<li class="nav-item dropdown notifications-nav">
				...
				<div class="dropdown-menu dropdown-primary" aria-labelledby="navbarDropdownMenuLink">					
					<a class="dropdown-item" href="admin_profile.php?supervisor-id=<?php echo $_SESSION["supervisor_id"]; ?>">          
			...
			<li class="nav-item dropdown notifications-nav">
				...
				<div class="dropdown-menu dropdown-primary" aria-labelledby="navbarDropdownMenuLink">					
					<a class="dropdown-item" href="password-update-form.php?supervisor-id=<?php echo $_SESSION["supervisor_id"]; ?>">          
