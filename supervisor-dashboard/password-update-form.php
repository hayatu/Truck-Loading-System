...
if(array_key_exists("password",$_REQUEST)){
	...
	The Password lenght must be between at least 6 & 10 Characters and mus Contain at Least 1 Capital Letter!
        ...
        $query2 = sprintf("update tbl_supervisor_info set password = %s where supervisor_id = %s",						
...
<main class="pl-1 pt-1">
    <div class="container">
		...
		<input name="supervisor-id" type="hidden" id="supervisor-id" value="<?php echo $_SESSION["supervisor_id"]; ?>">
