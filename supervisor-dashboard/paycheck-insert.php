...
$conn = db_connect();
            		...
            		// insert 
			          $query1 = sprintf("insert into tbl_paycheck_info(gross_pay_total, commission,fuel, insurance_fee,other_charges, net_pay,truck_id,sdate,edate,emp_id,week_name) values(%s,%s,%s,%s,%s, %s, %s, %s, %s,%s,%s)", 
