...
$conn = db_connect();
           ...
           $query2 = sprintf("update tbl_load_info set pick_up_price = %s, pick_up_location = %s, delivery_location= %s ,other_Notes = %s, emp_id = %s,truck_id = %s, week_name = %s,sdate = %s,edate = %s where load_id = %s",						
