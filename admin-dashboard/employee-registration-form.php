...
<main class="pl-1 pt-1">
    <div class="container">
        ...
        <!-- Register form -->
        <form name="form1" action="employee-insert.php" method="post" enctype="multipart/form-data">
            <p class="h5 text-center mb-0">Employee Registration Form</p>
            <hr class="light-blue lighten-1 title-hr">
            <!--Grid row-->
            <div class="row">
                <!--Grid column-->
				...
				<label for="vehicle_id" class="active">Truck Number</label>
