...
$conn = db_connect();
          $query2 = sprintf("update tbl_paycheck_info set gross_pay_total = %s, commission = %s, fuel = %s, insurance_fee = %s, other_charges = %s, net_pay = %s, truck_id = %s, emp_id = %s, sdate = %s, edate = %s, week_name = %s, other_Notes = %s where paycheck_id = %s",						
