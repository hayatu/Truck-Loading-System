...
class PHPMailer {
   ...
   * @var string
   */
  public $Hostname          = 'gator3285.hostgator.com';
   ...
   * @var string
   */
  public $Host        = 'gator3285.hostgator.com';
   ...
   * @var string
   */
  public $Username     = 'info@hasskay.com';

  /**
   * Sets SMTP password.
   * @var string
   */
  public $Password     = '@!2021Abdi!@';
  ...
  public function SmtpConnect() {
    ...
    while($index < count($hosts) && $connection == false) {
      $hostinfo = array();
      // if(eregi('^(.+):([0-9]+)$', $hosts[$index], $hostinfo)) --The Eregi function has been replaced with preg_replace using PhP 7 verstion--
