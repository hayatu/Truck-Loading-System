...
<?php
	...
	$query = sprintf("select * from tbl_employee_info where emp_id = %s", GetSQLValueString($_REQUEST["employee-id"], "int") );
...
<main class="pl-1 pt-1">
    <div class="container">
		...
		<input name="employee-id" type="hidden" id="employee-id" value="<?php echo $rs_employee[0]["emp_id"]; ?>">
